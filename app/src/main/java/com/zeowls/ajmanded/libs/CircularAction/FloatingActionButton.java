 ...
 */
package com.zeowls.ajmanded.libs.CircularAction;
...
public class FloatingActionButton extends FrameLayout {
    ...
    public static class Builder {
        ...
        public Builder setContentView(View contentView) {
            int image_size = context.getResources().getDimensionPixelSize(R.dimen.action_button_image_size);
            LayoutParams image_layoutParams = new LayoutParams(image_size , image_size, Gravity.CENTER);
            return setContentView(contentView, image_layoutParams);
        }
